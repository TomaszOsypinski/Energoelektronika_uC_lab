...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU8" URI="http://resources/4.1.26/app/PWM_CCU8/0" description="PWM APP using one timer slice of CCU8, with external events and dead time support, to generate up to 4 PWM outputs." mode="NOTSHARABLE" version="4.1.26" minDaveVersion="4.3.2" instanceLabel="PWM_CCU8_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="Out - CCU8 CH2 Direct PAD" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_port_ch2_out2" hwSignal="pad" hwResource="//@hwResources.3"/>
  ...
  <hwResources name="CC8 Config" URI="http://resources/4.1.26/app/PWM_CCU8/0/hwres_ccu8_cc8_slice" resourceGroupUri="peripheral/ccu8/0/cc8/0" constraintType="GLOBAL_RESOURCE" mResGrpUri="peripheral/ccu8/*/cc8/*">
  ...
  <hwResources name="PWM_CCU8 CH2 Direct Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/hwres_port_ch2_out2" resourceGroupUri="resources/48.0.0/port/p/0/pad/10" mResGrpUri="port/p/*/pad/*">
  ...
  <hwResources name="PWM_CCU8 CH1 Direct Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/__pin_hwres_port_ch1_out0" resourceGroupUri="devicepackage/0/141" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <hwResources name="PWM_CCU8 CH2 Direct Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/__pin_hwres_port_ch2_out2" resourceGroupUri="resources/lqfp144.0.0/devicepackage/0/3" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_period_match_interrupt/http://resources/4.0.6/app/VADC_GROUP_CONFIG/0/vs_vadc_group_config_queue_greqtr0sel" sourceSignal="event_period_match" targetSignal="queue_trigger_input" srcVirtualSignal="//@virtualSignals.1">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../VADC_GROUP_CONFIG/v4_0_6/VADC_GROUP_CONFIG_0.app#//@virtualSignals.2"/>
    <targetVirtualSignal href="../../VADC_GROUP_CONFIG/v4_0_6/VADC_GROUP_CONFIG_0.app#//@virtualSignals.2"/>
  </connections>
</ResourceModel:App>
