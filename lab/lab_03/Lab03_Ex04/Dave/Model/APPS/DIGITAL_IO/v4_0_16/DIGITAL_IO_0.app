...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DIGITAL_IO" URI="http://resources/4.0.16/app/DIGITAL_IO/0" description="The DIGITAL_IO APP is used to configure &#xA; a port pin as digital Input/Output." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="in_trap" appLabel="">
  ...
  <hwResources name="pin" URI="http://resources/4.0.16/app/DIGITAL_IO/0/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/128" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.16/app/DIGITAL_IO/0/http://resources/4.0.16/app/DIGITAL_IO/0/vs_digital_io_pad_pin/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_gp2_unsync" sourceSignal="pin" targetSignal="ext_event2" srcVirtualSignal="//@virtualSignals.1">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../PWM_CCU8/v4_1_26/PWM_CCU8_0.app#//@virtualSignals.16"/>
    <targetVirtualSignal href="../../PWM_CCU8/v4_1_26/PWM_CCU8_0.app#//@virtualSignals.16"/>
  </connections>
</ResourceModel:App>
